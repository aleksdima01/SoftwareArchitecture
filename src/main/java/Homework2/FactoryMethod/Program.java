...
public class Program {
    ...
    public static String text = """
             ...
             itself, because it is pain, but because occasionally circumstances occur in which toil and pain can procure him some great pleasure. To 
             ...
             right to find fault with a man who chooses to enjoy a pleasure that has no annoying consequences, or one who avoids a pain that produces 
             no resultant pleasure?""";

    public static void main(String[] args) {
LogReader logReader=new ConcreteReaderCreator()
        .createLogReader(LogType.Text,text);
logReader.setDataSource(text);
        System.out.println(logReader.getDataSource());
    }
}
