...
public class Program {
    public static void main(String[] args) {
        Harvester scania = new Harvester("Scania", "R340", Color.black);
        RefuelingStation neste = new RefuelingStation();
        RefuelingStation shell = new RefuelingStation();
        scania.setRefuelingStation(neste);
        scania.setFuelType(FuelType.Diesel);
        scania.fuel();
        Harvester mercedes = new Harvester("Mercedes", "Arco", Color.red);
        mercedes.setRefuelingStation(shell);
        mercedes.setFuelType(FuelType.Gas);
        mercedes.fuel();
        VipeStation vipeStation = new VipeStation();
        mercedes.setVipeStation(vipeStation);
        mercedes.wash(true, false, true);
    }
